...
//Back\public\img\uploads\1\998\677998.png
const image = await loadImage('./public/img/uploads/1/998/677998.png');

console.log(image);
//return;

var key = get_chroma_key("#FFFFFF");
...
function get_chroma_key(hex) {
    var n, p = parseInt, color = hex;
